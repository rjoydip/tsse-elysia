...
/**
 * Shared analytics loading state component
 */
...
/**
 * Shared analytics error state component
 */
export function AnalyticsErrorState({ error }: { error: string }) {
  return (
    <div className="space-y-4">
      <Card>
        <CardHeader>
...
/**
 * Shared analytics empty state component
 */
    ...
    <div className="space-y-4">
      ...
      <div className="grid grid-cols-1 gap-4 lg:grid-cols-8">
        <Card className="col-span-1 lg:col-span-5">
          ...
          <CardContent>
            <div className="text-center text-muted-foreground py-8">No role data available</div>
          </CardContent>
        </Card>
        <Card className="col-span-1 lg:col-span-3">
          <CardHeader>
          ...
          <CardContent>
            <div className="text-center text-muted-foreground py-8">No status data available</div>
          </CardContent>
        </Card>
      </div>
    </div>
