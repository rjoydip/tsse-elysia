...
describe("Username Generation", () => {
  it("should generate username from name with spaces", () => {
  ...
  it("should generate username from name with special characters", () => {
  ...
  it("should use provided username if given", () => {
