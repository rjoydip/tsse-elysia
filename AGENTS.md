...
1. **Validation**: Checks working tree is clean, conventional commits exist
2. **Quality**: Lint, typecheck, tests
3. **Security**: Audit
4. **Build**: Application build
5. **Version**: Bump version with changelogen
6. **Tag**: Create git tag (e.g., `v1.2.0`)
7. **Release**: Create GitHub Release with changelogithub
